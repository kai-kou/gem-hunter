...
<!-- Vendored from https://github.com/typesafe-ai/skills (skills/typesafe-ai/SKILL.md), MIT License,
     fetched 2026-09-17 with no modifications other than this notice. See NOTICE at the repository root.
     本ベースでの活用方針（opt-in・非対称・バージョン固定・フォールバック）は docs/jev-integration.md が正本。 -->
