...
| 条件                                                                                          | 代替手順                                                                                               | 品質への影響                                                                                           |
| --------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ |
| `Agent` が利用不可（ツール一覧に `Agent` が含まれない、または呼び出しが即座にエラー終了する） | **3 役割を順次適用**（並列ではなく逐次実行）する。独立性は無いため、同じ思い込みを共有する可能性がある | **但し書きを Step 5 完了報告に記載する**: 「独立性を担保した 3 レンズではなく、逐次適用の 3 観点です」 |
