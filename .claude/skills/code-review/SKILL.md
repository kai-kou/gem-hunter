...
| ドキュメント整合                                                                               | ルール・SKILL.md・README との desync・参照切れ。**手順書・SKILL.md に規律や手順を追加した差分では、追加位置の見出し階層を上へ辿り、そのスコープ（対象読者・対象ケース）が追加した記述の想定読者と一致するか確認する**（例: 「〜のみ」「〜限定」という見出しの配下に、限定対象と異なる読者向けの記述を置いていないか）。一致しない場合は、記述の移動か見出しスコープの修正のどちらかを求める。**既存の齟齬でも、追加した記述がその齟齬の影響を受ける位置にあるなら、それは今回の変更が作った問題として同じ PR での修正を求める**（無関係な既存の壊れの指摘とは区別する）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
